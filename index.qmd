...
这是与 `mathmodels` 包配套的中文使用手册，使用黄湘云提供的 [`quarto` 中文书籍模板](https://github.com/XiangyunHuang/quarto-book)编写，内容整合自该包的 vignettes，目前只完整包含**评价类算法**。
...
欢迎加入我的个人知识库，里面有所有整理好的我出品的基于 tidyverse/mlr3verse 的全网最新的 R 语言编程、R 机器学习、数学建模学习、案例资料，可以下载，可以 DeepSeek 问答：
